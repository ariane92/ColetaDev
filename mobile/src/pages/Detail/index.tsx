        ...
        <SafeAreaView style={{ flex: 1}}>
            <View style={styles.container}>
                <TouchableOpacity onPress={handleNavigateBack}>
                    ...
                    <Image style={styles.pointImage} source={{ uri: 'http://observatoriojirau.com.br/wp-content/uploads/2015/12/reciclado-1.jpg'}} />
                    <Text style={styles.pointName}>Carone</Text>
